...
class TestApp:
    ...
    def test_platforms(self):
        app = App()
        assert 'wechat' in app.registry.list_platforms()
    def test_get_adapter(self):
        app = App()
        a = app._get_adapter('wechat')
        assert a is not None and a.platform_name == 'wechat'
    def test_get_adapter_none(self):
        app = App()
        assert app._get_adapter('nope') is None
